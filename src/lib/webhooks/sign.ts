...
//
// Every delivery carries an `X-CodixIA-Signature` header so receivers
// can verify the request really came from CodixIA and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-CodixIA-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-CodixIA-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a CodixIA-to-CodixIA integration
